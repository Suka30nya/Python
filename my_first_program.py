# we can use capital letters for naming variables to consider them as constant, although compiler does not throw any error while compiling when you try to update it
import builtins
# ""
# ''
# """ """
